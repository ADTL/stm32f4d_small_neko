...
int main(void)
{
  ...
  gdispFillArea(10, 10, 80, 60, HTML2COLOR(0x0000ff));
  chThdSleepMilliseconds(500);
  gdispFillArea(10, 10, 80, 60, background);
  ...
  while(TRUE)
      ...
      if (random() & 8)
	{
      ...
      coord_t dest_x = -30 + (random() % 129);
      coord_t dest_y = -30 + (random() % 94);

      if (dest_x < 0)   dest_x = 0;
      if (dest_x > 69) dest_x = 69;
      if (dest_y < 0)   dest_y = 0;
      if (dest_y > 48) dest_y = 48;
